...
var NativeCropPage = /** @class */ (function () {
    ...
    NativeCropPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-native-crop',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/native/native-crop/native-crop.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Native Crop</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <button ion-button block color="primary" (click)="getMedia()" > Get Picture and Crop</button>\n  <br>\n  <img [src]="croped_image" *ngIf="croped_image" />\n  <p> {{ successMessage }} </p>\n  <p> {{ errorMessage }} </p>\n  <br>\n\n\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/native/native-crop/native-crop.html"*/,
        }),
