...
var TestimonialsPage = /** @class */ (function () {
    ...
    TestimonialsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-testimonials',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/miscellaneous/testimonials/testimonials.html"*/'<ion-header>\n	<ion-navbar color="primary">\n		<button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n		<ion-title>Testimonials</ion-title>\n	</ion-navbar>\n</ion-header>\n<ion-content>\n	<div *ngFor="let testimonial of testimonials">\n		<figure class="snip1574">\n			<img [src]="testimonial.imageUrl" alt="profile-sample2" />\n			<figcaption>\n				<blockquote>\n					<p>{{testimonial.quote}}</p>\n				</blockquote>\n				<h3>{{testimonial.name}}</h3>\n				<h5>{{testimonial.position}}</h5>\n			</figcaption>\n		</figure>\n	</div>\n</ion-content>'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/miscellaneous/testimonials/testimonials.html"*/
        }),
