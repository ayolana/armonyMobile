...
var SliderListPage = /** @class */ (function () {
    ...
    SliderListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-slider-list',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/slide/slider-list/slider-list.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>Slider List</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-list no-margin *ngFor="let item of items">\n    <ion-slides pager>\n      <ion-slide *ngFor="let slide of item.slides"\n                 class="text-center slider-item"\n                 [ngStyle]="{\'background-image\': \'url(\' + slide.imageUrl +\')\'}">\n        <div class="slide-text">\n          <h2>{{slide.title}}</h2>\n          <p>{{slide.songs}} songs</p>\n        </div>\n      </ion-slide>\n    </ion-slides>\n  </ion-list>\n</ion-content>\n\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/slide/slider-list/slider-list.html"*/
        }),
