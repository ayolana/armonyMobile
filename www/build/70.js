...
var FirebaseAuthPage = /** @class */ (function () {
    ...
    FirebaseAuthPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-firebase-auth',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/firebase/firebase-auth/firebase-auth.html"*/'<ion-content class="transparent-header" [ngStyle]="{\'background-image\': \'url(\' + backgroundImage +\')\'}">    \n  <ion-header no-border>\n    <ion-navbar transparent>\n    </ion-navbar>\n  </ion-header>\n  <div class="login-container">\n    <img class="logo" src="assets/img/logo/logo.png" />\n    <ion-row>\n      <ion-col text-center>\n        <h3>Welcome to Ionium 2</h3>\n        <p>Lorem ipsum lorem ipsum lorem ipsum lorem ipsum lorem ipsum</p>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col col-6>\n        <button ion-button block color="primary" outline (click)="goToLogin()">Log in</button>\n      </ion-col>\n      <ion-col col-6>\n        <button ion-button block (click)="goToSignup()">Create Account</button>\n      </ion-col>\n    </ion-row>\n  </div>\n</ion-content>'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/firebase/firebase-auth/firebase-auth.html"*/
        }),
