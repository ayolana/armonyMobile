...
var MasonryCardsPage = /** @class */ (function () {
    ...
    MasonryCardsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-masonry-cards',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/miscellaneous/masonry-cards/masonry-cards.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Masonry Cards</ion-title>\n  </ion-navbar>\n\n</ion-header>\n<ion-content>\n  <div class="pins">\n    <ion-card class="pin" *ngFor="let post of posts">\n      <img [src]="post.image" />\n      <div *ngIf="post.description" class="post-description">\n        <small>{{ post.description }}</small>\n      </div>\n      <ion-item>\n        <ion-avatar item-start>\n          <img src="assets/img/avatar/marty-avatar.png">\n        </ion-avatar>\n        <small>McFly</small>\n        <p><small>Category</small></p>\n      </ion-item>\n    </ion-card>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/miscellaneous/masonry-cards/masonry-cards.html"*/,
        }),
