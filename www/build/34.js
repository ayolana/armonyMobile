...
var NativeCameraPage = /** @class */ (function () {
    ...
    NativeCameraPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-native-camera',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/native/native-camera/native-camera.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Native Camera</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  \n    This is my camera app :\n    <br>\n    <button ion-button block color="primary" (click)="takePicture()">Take a Picture</button>\n    <br>\n    Latest Picture:<br>\n    <img [src]="base64Image" *ngIf="base64Image" />\n    <br>\n    <p> {{ errorMessage }} </p>\n\n</ion-content>'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/native/native-camera/native-camera.html"*/,
        }),
