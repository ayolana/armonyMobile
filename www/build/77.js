...
var CrudFirebaseDetailPage = /** @class */ (function () {
    ...
    CrudFirebaseDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-crud-firebase-detail',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/crud/crud-firebase-list/crud-firebase-detail/crud-firebase-detail.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button menuToggle *ngIf="!selectedItem">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>CRUD Firebase Detail</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n  <ion-item>\n    <ion-input type="text" [(ngModel)]="dataNotes.title" placeholder="New Note Title"></ion-input>\n  </ion-item>\n  <ion-item>\n    <ion-textarea [(ngModel)]="dataNotes.text" placeholder="Your Text Here"></ion-textarea>\n  </ion-item>\n  <ion-col>\n    <button ion-button color="primary" (click)="saveNotes()">Save</button>\n    <button ion-button color="danger" (click)="back()">Back</button>\n  </ion-col>\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/crud/crud-firebase-list/crud-firebase-detail/crud-firebase-detail.html"*/,
        }),
