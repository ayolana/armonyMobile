...
var FirebaseListPage = /** @class */ (function () {
    ...
    FirebaseListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-firebase-list',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/firebase/firebase-list.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Firebase</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-list>\n    <div *ngFor="let item of items">\n      <div *ngIf="item.component == \'logout\'">\n        <button ion-item (click)="doLogout($event)">\n          {{item.title}}\n        </button>\n      </div>\n      <div *ngIf="item.component != \'logout\'">\n        <button ion-item (click)="itemTapped($event, item)">\n          {{item.title}}\n        </button>\n      </div>\n    </div>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/firebase/firebase-list.html"*/,
        }),
