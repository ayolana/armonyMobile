...
var NativePhotoLibraryPage = /** @class */ (function () {
    ...
    NativePhotoLibraryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-native-photo-library',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/native/native-photo-library/native-photo-library.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Native Photo Library</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n\n  <ion-grid class="form-container">\n      <ion-row>\n        <ion-col *ngFor="let item of showPhoto; let i = index" col-6 col-sm-4 col-md-6 col-lg-4 col-xl-2>\n          <img [src]="item.photoURL" />\n        </ion-col>\n      </ion-row>\n  </ion-grid>\n\n  <p> {{ successMessage }} </p>\n  <p> {{ errorMessage }} </p>\n\n</ion-content>\n'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/mobileApp/src/pages/native/native-photo-library/native-photo-library.html"*/,
        }),
