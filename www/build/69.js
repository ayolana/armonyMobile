...
var FirebaseLoginPage = /** @class */ (function () {
    ...
    FirebaseLoginPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-firebase-login',template:/*ion-inline-start:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/firebase/firebase-auth/firebase-login/firebase-login.html"*/'<ion-content padding class="transparent-header" [ngStyle]="{\'background-image\': \'url(\' + backgroundImage +\')\'}">    \n  <ion-header no-border>\n    <ion-navbar transparent>\n    </ion-navbar>\n  </ion-header>\n  <div class="login-container">\n    <img class="logo" src="assets/img/logo/logo.png" />\n    <h2>Login</h2>\n    <ion-row>\n      <form [formGroup]="loginForm" (ngSubmit)="doLogin()">\n        <ion-item padding-right>\n          <ion-label>Email</ion-label>\n          <ion-input type="text" formControlName="email" ></ion-input>\n        </ion-item>\n        <ion-item padding-right>\n          <ion-label>Password</ion-label>\n          <ion-input type="password" formControlName="password" ></ion-input>\n        </ion-item>\n        <div>\n          <button ion-button class="submit-btn" full type="submit" >Login</button>\n        </div>\n      </form>\n    </ion-row>\n  </div>\n</ion-content>'/*ion-inline-end:"/Applications/XAMPP/xamppfiles/htdocs/codegate/app/src/pages/firebase/firebase-auth/firebase-login/firebase-login.html"*/,
        }),
